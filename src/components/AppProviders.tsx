                                                    ...
                                                    <GamesContext.Provider value={games}>
                                                      <SetGamesContext.Provider value={setGames}>
                                                        <StarsContext.Provider value={stars}>
                                                          <SetStarsContext.Provider value={setStars}>
                                                            <TutorialCompletedIndexContext.Provider value={tutorialCompletedIndexContext}>
                                                              <SetTutorialCompletedIndexContext.Provider value={setTutorialCompletedIndexContext}>
                                                                <AcquiredIconIndicesContext.Provider value={acquiredIconIndices}>
                                                                  <SetAcquiredIconIndicesContext.Provider value={setAcquiredIconIndices}>
                                                                    {children}
                                                                  </SetAcquiredIconIndicesContext.Provider>
                                                                </AcquiredIconIndicesContext.Provider>
                                                              </SetTutorialCompletedIndexContext.Provider>
