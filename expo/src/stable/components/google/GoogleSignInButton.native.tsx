...
// https://github.com/supabase/supabase/blob/master/examples/auth/expo-social-auth/components/social-auth-buttons/google/google-sign-in-button.tsx
// より。
