...
type Props = {
  ...
  darkObjectAccent: ColorValue;
  darkObject: ColorValue;
};
    ...
    >
      <View style={styles.row}>
        ...
        <TouchableOpacity
          style={[
            styles.button,
            { opacity: isAtStart ? 0.4 : 1.0, backgroundColor: primary },
          ]}
          onPress={onPrevious}
          disabled={isAtStart}
          activeOpacity={0.7}
        >
          <Text style={[styles.buttonText, { color: darkObject }]}>◀</Text>
        </TouchableOpacity>
          ...
          {containerWidth > 0 && (
            <View style={styles.overlayContainer}>
                  ...
                  <Svg width={containerWidth} height={CHART_HEIGHT}>
                    ...
                    {linePathD.length > 0 && (
                      <Path
                        d={linePathD}
                        fill="none"
                        stroke={darkObjectAccent} // darkObjectAccent
                        strokeWidth={1.5}
                        strokeLinecap="round"
                    ...
                    <Circle
                      ...
                      stroke={primaryDark} //primaryDark
                      strokeWidth={1.5}
                    />
                  </Svg>
                </View>
              ...
              <Slider
                ...
                minimumTrackTintColor={`${String(darkObject)}90`} // darkObject
                maximumTrackTintColor={`${String(primaryDark)}90`} // primaryDark
                thumbTintColor={`${String(darkObject)}E0`} // darkObject
              />
            </View>
          )}
        </View>
        ...
        <TouchableOpacity
          style={[
            styles.button,
            { opacity: isAtEnd ? 0.4 : 1.0, backgroundColor: primary },
          ]}
          onPress={onNext}
          disabled={isAtEnd}
          activeOpacity={0.7}
