...
ALTER TABLE "system"."app_status" OWNER TO "postgres";
...
ALTER TABLE "system"."rate_limit" OWNER TO "postgres";
...
ALTER TABLE ONLY "game"."playing" ALTER COLUMN "id" SET DEFAULT "nextval"('"game"."matches_new_id_seq"'::"regclass");
...
CREATE OR REPLACE TRIGGER "playing_archive" AFTER UPDATE ON "game"."playing" FOR EACH ROW WHEN ((("new"."status" = 'finished'::"text") AND ("old"."status" IS DISTINCT FROM 'finished'::"text"))) EXECUTE FUNCTION "game"."archive_playing"();
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "game"."playing";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "system"."app_status";
