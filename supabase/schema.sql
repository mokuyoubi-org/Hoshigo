...
CREATE OR REPLACE FUNCTION "private"."calculate_icons"("p_points9" smallint, "p_points13" smallint) RETURNS smallint[]
...
ALTER FUNCTION "private"."calculate_icons"("p_points9" smallint, "p_points13" smallint) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "private"."get_bot_match_info"("p_points" smallint, "p_board_size" smallint, OUT "o_bot_uid" "uuid", OUT "o_match_type" smallint) RETURNS "record"
    LANGUAGE "plpgsql" IMMUTABLE
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "private"."points_to_rank"("p_points" smallint) RETURNS smallint
...
ALTER FUNCTION "private"."points_to_rank"("p_points" smallint) OWNER TO "postgres";
