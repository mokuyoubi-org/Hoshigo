...
//           <Text style={styles.pageTitle}>{t("Watch.title")}</Text>
//         </View>
//         <Text style={styles.pageSubtitle}>{t("Watch.subtitle")}</Text>
//       </View>
...
//             titleColor="rgba(201,168,76,0.6)"
//             colors={[GOLD]}
//             progressBackgroundColor="#0f0f18"
//           />
//         }
//       >
